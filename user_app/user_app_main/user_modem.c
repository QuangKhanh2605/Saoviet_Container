...
uint8_t aDCU_ID[MAX_DCU_ID_LENGTH] = DEVICE_ID;
    ...
    StructManageRecordFlash     sRecTSVH = 
    {
        .AddStart_u32       = ADDR_MESS_A_START,   
        .AddStop_u32        = ADDR_MESS_A_STOP,
    ...
    StructManageRecordFlash     sRecEvent = 
    {
        .AddStart_u32       = ADDR_EVENT_START,
        .AddStop_u32        = ADDR_EVENT_STOP,
    ...
    //Struct Log Ðata
    StructManageRecordFlash     sRecLog =    
    {
        .AddStart_u32       = ADDR_LOG_START,   
        .AddStop_u32        = ADDR_LOG_STOP,
    ...
    StructManageRecordFlash     sRecTSVH = 
    {
        .AddStart_u32       = CAT_ADDR_MESS_A_START,                      
        .AddStop_u32        = CAT_ADDR_MESS_A_STOP,
            
        .AddIndexSend_u32   = CAT_ADDR_INDEX_TSVH_SEND,          
        .AddIndexSave_u32   = CAT_ADDR_INDEX_TSVH_SAVE,
    ...
    StructManageRecordFlash     sRecEvent = 
    {
        .AddStart_u32       = CAT_ADDR_EVENT_START,
        .AddStop_u32        = CAT_ADDR_EVENT_STOP,
            
        .AddIndexSend_u32   = CAT_ADDR_INDEX_EVENT_SEND,
        .AddIndexSave_u32   = CAT_ADDR_INDEX_EVENT_SAVE,
    ...
    StructManageRecordFlash     sRecLog = 
    {
        .AddStart_u32       = CAT_ADDR_LOG_START,   
        .AddStop_u32        = CAT_ADDR_LOG_STOP,
            
        .AddIndexSend_u32   = CAT_ADDR_INDEX_LOG_SEND,   
        .AddIndexSave_u32   = CAT_ADDR_INDEX_LOG_SAVE,
...
//    } else
//    {
//    	UTIL_Log((uint8_t *) "Xung chua vuot qua 5\r\n", 22);
//    }
